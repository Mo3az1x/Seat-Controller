...
public class Main {
    ...
    private static void printBanner() {
        ...
        System.out.println("║          Supports I2C, SPI, UART Protocols                   ║");
        System.out.println("╚═══════════════════════════════════════════════════════════════╝");
        System.out.println();
    }
    ...
    private static void handleCommandLineArgs(String[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            switch (args[i].toLowerCase()) {
                ...
                case "--protocol":
                    if (i + 1 < args.length) {
                        String protocol = args[++i].toUpperCase();
                        if (Arrays.asList("I2C", "SPI", "UART").contains(protocol)) {
                            currentProtocol = protocol;
                            System.out.println("Default protocol set to: " + currentProtocol);
                        } else {
                            System.err.println("Invalid protocol: " + protocol);
                            System.err.println("Supported protocols: I2C, SPI, UART");
                        }
                    }
                    break;
                case "-help":
    ...
    private static void printUsage() {
        ...
        System.out.println("  -protocol <type>  Set protocol (I2C, SPI, UART - default: UART)");
    ...
    private static void showMainMenu() {
        ...
        System.out.println("  protocol <type>   - Set protocol (I2C/SPI/UART)");
        System.out.println();
    ...
    private static void showConnectionStatus() {
        if (sniffer == null) {
            ...
            System.out.println("Default protocol: " + currentProtocol);
        } else {
            System.out.println("Status: CONNECTED");
            System.out.println("Port: " + currentPort);
            System.out.println("Baud: " + currentBaud);
            System.out.println("Protocol: " + currentProtocol);
    ...
    private static void setProtocol(String protocol) {
        if (protocol == null) {
            ...
            System.out.println("Available protocols: I2C, SPI, UART");
            return;
        }
        ...
        if (Arrays.asList("I2C", "SPI", "UART").contains(protocol)) {
            currentProtocol = protocol;
            System.out.println("Protocol set to: " + currentProtocol);
            
            if (sniffer != null) {
                System.out.println("Note: Reconnect to apply protocol change.");
            }
        } else {
            System.err.println("Invalid protocol: " + protocol);
            System.err.println("Supported protocols: I2C, SPI, UART");
