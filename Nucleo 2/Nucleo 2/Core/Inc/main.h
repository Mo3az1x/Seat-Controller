...
#define Height_up_Pin GPIO_PIN_4
#define Height_up_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define Slide_up_Pin GPIO_PIN_6
#define Slide_up_GPIO_Port GPIOA
#define Incline_up_Pin GPIO_PIN_7
#define Incline_up_GPIO_Port GPIOA
#define Height_dwn_Pin GPIO_PIN_4
#define Height_dwn_GPIO_Port GPIOC
#define Slide_dwn_Pin GPIO_PIN_5
