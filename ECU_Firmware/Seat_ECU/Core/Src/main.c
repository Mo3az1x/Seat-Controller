...
/* USER CODE BEGIN Header_ControlManagerTask */
/**
  * @brief  Function implementing the ControlManager thread.
...
/* USER CODE BEGIN Header_ModeManagerTask */
/**
...
/* USER CODE BEGIN Header_ProfileManagerTask */
/**
* @brief Function implementing the ProfileManager thread.
* @param argument: Not used
* @retval None
*/
...
void ProfileManagerTask(void *argument)
{
  ...
  /* USER CODE END ProfileManagerTask */
}

/* USER CODE BEGIN Header_FaultManagerTask */
/**
* @brief Function implementing the FaultManager thread.
* @param argument: Not used
* @retval None
*/
...
void FaultManagerTask(void *argument)
{
  ...
  /* USER CODE END FaultManagerTask */
}
