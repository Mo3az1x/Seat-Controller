...
/* Definitions for Task_Nvm */
osThreadId_t Task_NvmHandle;
const osThreadAttr_t Task_Nvm_attributes = {
  .name = "Task_Nvm",
  .stack_size = 256 * 4,
...
/* USER CODE BEGIN Header_NvmTask */
/**
* @brief Function implementing the Task_Nvm thread.
* @param argument: Not used
* @retval None
*/
